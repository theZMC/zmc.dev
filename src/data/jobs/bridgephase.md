...
isTech: true
summary: >-
  Contracted with the Air Force on Big Bang, the open-source implementation of
...
Contracted with the Air Force on Big Bang, the open-source implementation of
the DoD's DevSecOps reference architecture. Served on multiple mission teams
including Observability and Service Mesh — building and maintaining Helm
charts, steering project direction, implementing process improvements,
advising government stakeholders, and supporting end users of the platform.
