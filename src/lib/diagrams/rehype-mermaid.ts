...
function figurePlate(diagram: RenderedDiagram, ordinal: number): Element {
  ...
  return {
    ...
    children: [
      ...
      {
        // Positioning host for the right-edge overflow fade — site.ts
        // toggles data-clipped here while content continues past the
        // clip edge, the same affordance the code frames wear.
        type: "element",
        tagName: "div",
        properties: { className: ["diagram-body"] },
        children: [
          {
            type: "element",
            tagName: "div",
